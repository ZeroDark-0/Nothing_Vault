...
The directX and Vulkan's are the two are type of API that your hardware used where the directX is developed my Microsoft and the Vulkan's which is a generic API developed ***khronos group***..
...
Making is superior in the graphic cuz of the compatibility in the multiple OS,, even Valve is on the side of the Vulkan's instead depending upon the Windows,, cuz they have the SteamOS to be make it flexible with any game that release..
