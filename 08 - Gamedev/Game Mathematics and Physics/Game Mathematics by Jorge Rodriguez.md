...
```embed
title: "GitHub - ZeroDark-0/Game-Mathematics"
image: "https://opengraph.githubassets.com/15a6e16ce517b67c4d759f19028e2d43399f6982ba6c6ec0822f2383582de331/ZeroDark-0/Game-Mathematics"
description: "Contribute to ZeroDark-0/Game-Mathematics development by creating an account on GitHub."
url: "https://github.com/ZeroDark-0/Game-Mathematics"
favicon: ""
aspectRatio: "50"
```
...
- Quaternion <code style = "color : red"> (file number 32, 33, 34, 35, 36, 37, 38) </code> <code style = "color:cyan">Quaternions are used all over the place in game development, but mostly behind the scenes. Unity uses quaternions for all rotations, most skeletal animation systems use quaternions, they're great for camera systems for example. The new version of the bullet physics engine uses quaternions instead of rotation matrices. At the end of the quaternion series I will be going over an example and some applications of quaternions.</code>
- Matrix Transformation 
- Perspective Matrix and Damage Indicator 